...
def dictionary():
    ...
    #   "quantity" => 18
    #   "color" => "red"
    fruit_dict = dict(zip(["fruit","quantity","color"], ["apple",18,"red"]))
    k = list(fruit_dict.keys())
    for key in k:
...
def dictionary_nested():
    ...
    Grace = dict(zip(["name","jobs","age"],[{"first_name":"Grace", "last_name":"Hopper"}, ["scientist", "engineer"],85]))
